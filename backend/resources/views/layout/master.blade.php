        ...
        <header>
            <div class="container">
                <div class="sixteen columns">
                    ...
                    <div id="logo">
                        <h1><a href="/">
                                <img src="{{ asset('images/logo-02.png') }}" alt="Work Scout" />
                            </a></h1>
                    </div>
                    ...
                    <nav id="navigation" class="menu">
                        <ul id="responsive">
                            ...
                            @else
                                ...
                                <li>
                                    <a href="my-account.html#tab2"><i class="fa fa-user"></i> Sign Up</a>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="footer-bottom">
                    <div class="sixteen columns">
                        ...
                        <div class="copyrights">© Copyright 2015 by <a href="#">Work Scout</a>. All Rights
                            Reserved.</div>
                    </div>
                </div>
            </div>
